    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
        ...
        if (requestTokenHeader != null && requestTokenHeader.startsWith("Bearer ")) {
            ...
            try {
                ...
                log.debug("Token JWT extraído para usuario: {}", username);
            } catch (Exception e) {
                log.warn("Error al extraer username del JWT: {}", e.getMessage());
            }
        } else {
            log.trace("JWT Token no encontrado en el header Authorization");
        }
